...
<!-- 	<meta name="google-site-verification" content="" /> -->
	...
	<!-- CSS -->
<!-- 	<link rel="stylesheet" href="<?=$URLSITE?>/assets/css/normalize.min.css">
	<link rel="stylesheet" href="<?=$URLSITE?>/assets/css/bootstrap.min.css">
	<link rel="stylesheet" href="<?=$URLSITE?>/assets/css/slick.css">
	<link rel="stylesheet" href="<?=$URLSITE?>/assets/css/slick-theme.css">
	<link rel="stylesheet" href="<?=$URLSITE?>/assets/css/jquery.fancybox.min.css">
	<link rel="stylesheet" href="<?=$URLSITE?>/assets/css/perfect-scrollbar.css">
	
	<link rel="stylesheet" href="<?=$URLSITE?>/assets/css/style.css"> -->
...
<body>
	...
	<script src="https://maps.googleapis.com/maps/api/js?v=3&key=AIzaSyDlTsHipUyB9i6mZILHjkxVQsnoZGSzZ_4"></script>

 	<script src="<?=$URLSITE?>/assets/js/jquery.min.js"></script>
	<!-- <script src="<?=$URLSITE?>/assets/js/bootstrap.min.js"></script>
	<script src="<?=$URLSITE?>/assets/js/instafeed.min.js"></script>
	<script src="<?=$URLSITE?>/assets/js/isotope.pkgd.min.js"></script>
	<script src="<?=$URLSITE?>/assets/js/jquery.autocomplete.min.js"></script>
	<script src="<?=$URLSITE?>/assets/js/jquery.fancybox.min.js"></script>
	<script src="<?=$URLSITE?>/assets/js/jquery.mask.min.js"></script>
	<script src="<?=$URLSITE?>/assets/js/perfect-scrollbar.jquery.min.js"></script>
	<script src="<?=$URLSITE?>/assets/js/slick.min.js"></script>
	<script src="<?=$URLSITE?>/assets/js/wow.min.js"></script>
	<script src="<?=$URLSITE?>/assets/js/js.js"></script> -->

	<script src="<?=$URLSITE?>/assets/js/js.min.js"></script>
