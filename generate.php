...
function init(){
	...
	@mkdir("application/class/dto");
	@mkdir("application/class/mysql");
	@mkdir("application/class/mysql/ext");
	@mkdir("application/class/sql");
	@mkdir("application/class/dao");
	@mkdir("application/class/core");
	copy('templates/class/dao/sql/Connection.class.php', 'application/class/sql/Connection.class.php');
	copy('templates/class/dao/sql/ConnectionFactory.class.php', 'application/class/sql/ConnectionFactory.class.php');
	copy('templates/class/dao/sql/ConnectionProperty.class.php', 'application/class/sql/ConnectionProperty.class.php');
	copy('templates/class/dao/sql/QueryExecutor.class.php', 'application/class/sql/QueryExecutor.class.php');
	copy('templates/class/dao/sql/Transaction.class.php', 'application/class/sql/Transaction.class.php');
	copy('templates/class/dao/sql/SqlQuery.class.php', 'application/class/sql/SqlQuery.class.php');
	copy('templates/class/dao/core/ArrayList.class.php', 'application/class/core/ArrayList.class.php');
}
...
function createIncludeFile($ret){
	...
	$template->write('application/include_dao.php');
}
...
function createDAOFactory($ret){
	...
	$template->write('application/class/dao/DAOFactory.class.php');
}
...
function getnerateDomainObjects($ret){
	for($i=0;$i<count($ret);$i++){
		...
		$template->write('application/class/dto/'.$clazzName.'.class.php');
	}
}
...
function getnerateDAOExtObjects($ret){
	for($i=0;$i<count($ret);$i++){
		...
		$file = 'application/class/mysql/ext/'.$clazzName.'DAO.class.php';
		if(!file_exists($file)){
			$template->write('application/class/mysql/ext/'.$clazzName.'DAO.class.php');
		}
	}
}
...
function getnerateDAOObjects($ret){
	for($i=0;$i<count($ret);$i++){
		...
		$template->set('queryByFieldFunctions',$queryByField);		
		$template->set('deleteByFieldFunctions',$deleteByField);	
		$template->write('application/class/mysql/'.$clazzName.'DAO.class.php');
	}
}
...
function getnerateIDAOObjects($ret){
	for($i=0;$i<count($ret);$i++){
		...
		$template->set('queryByFieldFunctions',$queryByField);
		$template->set('deleteByFieldFunctions',$deleteByField);		
		$template->write('application/class/dao/'.$clazzName.'DAO.class.php');
	}
}
